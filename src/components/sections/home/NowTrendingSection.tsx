...
export function NowTrendingSection({ restaurants }: { restaurants: Restaurant[] }) {
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 flex items-end justify-between gap-2">
              <div className="min-w-0 flex-1">
                <p className="text-white text-[17px] font-bold leading-tight truncate">{restaurant.name}</p>
                ...
                {restaurant.cost_for_two && (
                  <p className="text-white/50 text-[11px] mt-0.5">₹{restaurant.cost_for_two} for two</p>
                )}
              </div>
              <button
                type="button"
